# Contributing to RefWireCLI

Thank you for your interest in contributing to RefWireCLI! Your contributions help improve the project and make it better for everyone. This document outlines the guidelines for contributing to the repository.
...
RefWireCLI adheres to a [Code of Conduct](CODE_OF_CONDUCT.md). Please read it to understand the expectations for community behavior. We are committed to creating a welcoming and respectful environment for everyone.

---

## How Can I Contribute?

There are several ways you can contribute to RefWireCLI:
...
To get started with developing on RefWireCLI:
...
- **GitHub Issues & Discussions:**  
  Use [GitHub Discussions](https://github.com/coretravis/RefWireCLI/discussions) to ask questions, propose ideas, or get help.
- **Direct Contact:**  
...
RefWireCLI is licensed under the MIT License. By contributing, you agree that your contributions will also be licensed under the MIT License.

---

## Acknowledgements

We appreciate your time and effort in helping improve RefWireCLI. Thank you for being a part of our community and for your valuable contributions!
